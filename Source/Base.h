...
int items_dat() {
	...
	for (int i = 0; i < itemCount; i++) {
		...
		if (i == 10112) items[i].surgeryprice = 2600;
		...
		if (i == 3798 || i == 6288 || i == 5138)  items[i].gtwl = 25;
		...
		if (i == 9538 || i == 7960)  items[i].oprc = 150;
		if (i == 11152)  items[i].oprc = 160;
		if (i == 5650)  items[i].oprc = 240;
		if (i == 5194)  items[i].oprc = 230;
		if (i == 8530)  items[i].oprc = 270;
		if (i == 8440) items[i].oprc = 300;
		if (i == 10684)  items[i].oprc = 350;
		if (i == 8864) items[i].oprc = 400;
		if (i == 8192) items[i].oprc = 450;
		if (i == 11662)items[i].oprc = 500;
		if (i == 5192)items[i].oprc = 600;
		if (i == 11750)  items[i].oprc = 800;
		if (i == 9166)  items[i].oprc = 2000;
		if (i == 9496)  items[i].oprc = 5000;
		if (items[i].oprc != 0) opc_item.push_back(make_pair(items[i].oprc, i));

		//premium shop
		if (i == 3724)  items[i].pwl = 1;
		if (i == 9168)  items[i].pwl = 3;
		if (i == 9350)  items[i].pwl = 5;
		if (i == 5138 || i == 11756)  items[i].pwl = 10;
		if (i == 1584 || i == 5140)  items[i].pwl = 25;
		if (i == 10826 || i == 10328 || i == 1796 || i == 1680 || i == 5482 || i == 5142 || i == 11758)  items[i].pwl = 50;
		if (i == 6334 || i == 10922)  items[i].pwl = 100;
		if (i == 11550)  items[i].pwl = 150;
		if (i == 7762 || i == 8496)  items[i].pwl = 200;
		if (i == 7650)  items[i].pwl = 300;
		if (i == 11464 || i == 11466 || i == 11470 || i == 9470 || i == 2722 || i == 11882 || i == 6948 || i == 1836 || i == 11562)  items[i].pwl = 500;
		if (i == 11884)  items[i].pwl = 750;
		if (i == 3134 || i == 1824 || i == 11750 || i == 5188 || i == 9384)  items[i].pwl = 1000;
		if (i == 9386 || i == 11752 || i == 6950 || i == 6952 || i == 9114)  items[i].pwl = 1500;
		if (i == 8308 || i == 6312 || i == 5136 || i == 11008)  items[i].pwl = 2000;
		if (i == 2450)  items[i].pwl = 2500;
		if (i == 3040 || i == 572 || i == 1442)  items[i].pwl = 3000;
		if (i == 5480 || i == 5638)  items[i].pwl = 3500;
		if (i == 9496 || i == 9166 || i == 7188)  items[i].pwl = 5000;
		...
		if (items[i].pwl != 0) shop_list += "\nadd_button_with_icon|shop_price_" + to_string(i) + "|`b" + items[i].name + "`` `0(```9" + to_string(items[i].pwl) + "Wls```0)``|noflags|" + to_string(i) + "|";
